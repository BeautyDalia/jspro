...
getFormValue = function(passwordInput) {
    n = {
        "rsaExponent": "010001",
    ...
    n.timesign = (new Date).getTime() + s;
    n.passwordEncrypted = encryptString(n.timesign + passwordInput, n.rsaExponent, n.rsaModulus);
    n.p = encryptString(n.timesign, n.rsaExponent, n.rsaModulus);
    return n.passwordEncrypted
}