...
function getPwd(username, password, captcha) {
    e = {
        username: username,
        password: password,
        captcha: captcha,
        check_n: "1PDP78A9T/3gkzvtWChcnRuBqZWlWWGhQEKVuvaRaJE7Xf5B9z…f1dL4pZGJWKFHlG7KIRFDgZ70QwAJA/Is52GIvecmeB/jKUE=",
        check_e: "AQAB"
    }
    q = e.check_n;
    l = e.check_e;
    ...
    return hex2b64(r.encrypt(md5(e.password) + z));
}